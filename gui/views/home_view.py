...
class HomeView(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_data_stream.clicked.connect(self._on_data_stream_clicked)
    ...
    def on_theme_combo_changed(self, index):
        ...
        print(f"[DEBUG] HomeView theme changed -> {chosen_data}")
        if chosen_data:
            self.themeSelectedSignal.emit(chosen_data)

    def set_theme_combo(self, theme_name):
        print(f"[DEBUG] HomeView.set_theme_combo({theme_name})")
    ...
    #                        BUTTON HANDLERS
    # ----------------------------------------------------------------
    def _on_data_stream_clicked(self):
        print("[DEBUG] Streamer button clicked -> emitting goDataStreamSignal")
        self.goDataStreamSignal.emit()

    def _on_pid_tuning_clicked(self):
        print("[DEBUG] Tuner button clicked -> emitting goPidTuningSignal")
