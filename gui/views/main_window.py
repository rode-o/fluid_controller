...
class MainWindow(QMainWindow):
    def __init__(self, app, parent=None):
        ...
        print("[DEBUG] Creating DataStreamerView...")
        self.data_streamer_view = DataStreamerView(self.settings)
        print("[DEBUG] Created DataStreamerView:", self.data_streamer_view)
        ...
        if saved_theme in ["purple","blue","green","gray","dark_gray","vivid_red"]:
            ...
            print(f"[DEBUG] Applied saved theme: {saved_theme}")
        else:
            # If none saved, default to something, e.g. "purple"
            self.apply_theme("purple")
            self.home_view.set_theme_combo("purple")
            print("[DEBUG] No saved theme found. Using default 'purple'.")

    def goto_data_streamer(self):
        print("[DEBUG] goto_data_streamer() -> setCurrentIndex(1)")
        self.stacked_widget.setCurrentIndex(1)

    def goto_pid_tuning(self):
        print("[DEBUG] goto_pid_tuning() -> setCurrentIndex(2)")
    ...
    def on_theme_selected(self, theme_name):
        ...
        """
        print(f"[DEBUG] Theme selected: {theme_name}")
    ...
    def apply_theme(self, theme_name):
        ...
        """
        print(f"[DEBUG] apply_theme({theme_name})")
        if theme_name == "purple":
            ...
            print("[DEBUG] Unknown theme:", theme_name)
